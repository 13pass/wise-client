...
class WiseClient {
  ...
  getBalancesStatements(profileId, balanceId, startDate, endDate) {
    const queryParams = `?intervalStart=${startDate}&intervalEnd=${endDate}`;
    const url = `/v1/profiles/${profileId}/balance-statements/${balanceId}/statement.json${queryParams}`;
